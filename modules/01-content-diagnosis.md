...
对用户的内容（或内容计划）做三个维度的诊断。**注意：文字洁癖/AI 味诊断不在这里做，路由到 `dylan-content-review-ai-check`；封面/标题诊断不在这里做，路由到 `dylan-content-review-hook`（封面/视觉）和 `dylan-content-review-titles`（标题公式匹配）。**
...
诊断完成后，若需要检查文字洁癖/AI 味或封面/标题，提示用户：**「表达效率和认知落差没问题了。文字有没有 AI 味，找 `dylan-content-review-ai-check`；封面标题怎么定，找 `dylan-content-review-hook` 或 `dylan-content-review-titles`。」**
