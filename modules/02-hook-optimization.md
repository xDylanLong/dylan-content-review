...
- 抖音观众可能没看到封面和标题。前 2 秒只报主题和核心动作，让观众知道在讲什么；前 5 秒再把主题放进具体人物、动作和压力。
- 前 2 秒和前 5 秒必须承担不同任务，不能只换几个词重复同一个问题。
- 前 5 秒不放定义、公式、研究背景或功能清单；但必须说出场景和问题。
- 前 10 秒明确本条要回答的问题，或给出具体后果、数字、追问或动作，让观众知道为什么要听下去。
