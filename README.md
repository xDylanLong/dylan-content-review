...
`dylan-content-review` 把这些判断拆成八个可按需读取的模块。它以用户提供的原句、事实和素材为证据，输出具体的删改位置、替代句、内容骨架或下一步动作，不承诺完播率、点击率或“必火”，也不默认从零生成完整成稿。
...
| `08-conversational-editing` | 社媒长文口语化、语义保真和新增套话清理 |
